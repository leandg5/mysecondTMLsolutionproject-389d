[mysecondTMLsolutionproject-389d] Operating Details
====================================

Generated On: 2024-11-07 02:38:57 UTC
...
.. important::
   ...
   **not be valid if your [mysecondTMLsolutionproject-389d] container is NOT running**.

.. tip::
   You must have your [mysecondTMLsolutionproject-389d] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/leandg5/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/leandg5/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40713  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='leandg5'  \-\-env DOCKERUSERNAME='leandg5'  \-\-env MQTTUSERNAME='leandrodg5'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   leandg5/mysecondTMLsolutionproject-389d-amd64 (https://hub.docker.com/r/leandg5/mysecondTMLsolutionproject-389d-amd64)
...
.. important::
   docker run -d -p 38747:38747 -p 46101:46101 -p 40767:40767 \-\-env TSS=0 \-\-env SOLUTIONNAME=mysecondTMLsolutionproject-389d \-\-env SOLUTIONDAG=solution_preprocessing_dag-mysecondTMLsolutionproject-389d \-\-env GITUSERNAME=leandg5  \-\-env GITREPOURL=https://github.com/leandg5/raspberrypi \-\-env SOLUTIONEXTERNALPORT=38747  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=46101  \-\-env SOLUTIONVIPERVIZPORT=40767 \-\-env DOCKERUSERNAME='leandg5'  \-\-env EXTERNALPORT=40713 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='leandrodg5' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  leandg5/mysecondTMLsolutionproject-389d-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=40767
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=38747
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - leandg5/mysecondTMLsolutionproject-389d-amd64
...
It can be accessed by entering: http://localhost:46101
...
.. important::
   http://localhost:40767/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:40767/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:40767/<html file>
...
[mysecondTMLsolutionproject-389d] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/leandg5/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/mysecondTMLsolutionproject-389d
...
.. important::
   https://mysecondTMLsolutionproject-389d.readthedocs.io
...
.. important::
   solution_preprocessing_dag-mysecondTMLsolutionproject-389d
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38747, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42237, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36821, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37667, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41489, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40565, HPDEHOST=127.0.1.1, HPDEPORT=44985, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42671

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3196-mysecondTMLsolutionproject-389d,solution_preprocessing_dag-mysecondTMLsolutionproject-389d, python-preprocess-3944-mysecondTMLsolutionproject-389d,solution_preprocessing_dag-mysecondTMLsolutionproject-389d, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
